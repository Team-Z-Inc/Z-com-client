    ...
    <div id={styles.productDetailsMainWrapper}>
      ...
      <div id={styles.productDetailsWrapper} className="container">
        ...
        <div id={styles.productInfoWrapper}>
          <div>
            ...
            <span>
              <p className={styles.reviews}>6 reviews</p>
            </span>
            <p className={styles.oldPrice}>
              <strike>$9.99</strike> <b className={styles.newPrice}>$6.99</b>{" "}
            </p>
          ...
          <div className={styles.availabillitySection}>
            <p>
              Availabillity :{" "}
              <span id={styles.availabillityInnerText}>
          ...
          <div id={styles.accordianWrapper}>
            ...
            <div id={styles.toggoleBar} onClick={toggleAccordion}>
              ...
              <MdOutlineKeyboardArrowDown className="mx-3 fs-4" />
            </div>
            <div
              id={styles.accordianItemWrapper}
              className={
                isAccordionOpen ? styles.showAccordion : styles.hideAccordion
              }
            >
          ...
          <div id={styles.buttonSectionWrapper}>
            ...
            <div id={styles.addToCartButton}>
              <span>
                {" "}
                <IoMdAdd id="animatedHover" />{" "}
                <p className="d-inline mx-1">Add To Cart</p>
              </span>
            </div>
          </div>
          ...
          <div>
            <p className="mt-5">
              Tags : <span className={styles.tagSkuColor}> Beer, Foamer</span>
            </p>
            <p>
              SKU : <span className={styles.tagSkuColor}> KE-91039</span>
            </p>
            <hr className={styles.hr} />
            <div>
              <span>
                ...
                <p className="text-danger">
                  <IoFlag color="red" /> Report This item
                </p>
              </span>
            </div>
            ...
            <div style={styles.shareIcon}>
              <span>
                ...
                <p className="mt-4">
                  ...
                  Share This:{" "}
                  <span>
                    <FaFacebookF className={styles.socialIconFb} />{" "}
                    <IoLogoPinterest className={styles.socialIconPrint} />{" "}
                    <IoLogoTwitter className={styles.socialIconTweet} />
                  </span>
                </p>
              </span>
            </div>
      ...
      <div className="container">
        <p>
          ...
          survived not only five centuries but also the on leap into electronic
          typesetting, remaining essentially unchanged. It wasn’t popularised in
          the 1960s with the release of Letraset sheets containing Lorem Ipsum
          passages, andei more recently with desktop publishing software like
          Aldus PageMaker including versions of Lorem Ipsum to make a type
          specimen book{" "}
        </p>
