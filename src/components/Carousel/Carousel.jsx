  ...
  <div id="carouselExampleIndicators" className="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div className="carousel-inner ">
      <div className="carousel-item active " data-bs-interval="3000" id={styles.carouselImg}>
        <img src="/img/slider img 1.png" className="d-block w-100 h-100" alt="..." />
      </div>
      <div className="carousel-item " data-bs-interval="3000" id={styles.carouselImg}>
        <img src="/img/slider 2.png" className="d-block w-100" alt="..." />
      </div>
      <div className="carousel-item " data-bs-interval="3000" id={styles.carouselImg}>
        <img src="/img/slider 3 .png" className="d-block w-100" alt="..." />
      </div>
    </div>
   </div>
  </div>
